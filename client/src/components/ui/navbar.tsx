...
const Navbar: React.FC = () => {
  ...
  const isHelpPage = url.pathname === "/help-page";
  ...
  return (
    <nav className={`h-[64px] flex items-center justify-between gap-2 py-6 ${isDashboardPage ? "px-6" : "px-12"} bg-[#106B40]`}>
      <div className="flex items-center">
        <Sun className="text-emerald-100" size={22} />
        <Link
          to={isOnboardingPage ? "/onboarding" : "/dashboard"}
